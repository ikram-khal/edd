...
const translations = {
  ...
  dashboard: { qq: 'Бас бет', ru: 'Главная' },
  members: { qq: 'Кеңес ағзалары', ru: 'Состав совета' },
  meetings: { qq: 'Мәжилислер', ru: 'Заседания' },
  active_votes: { qq: 'Актив даўыс бериў', ru: 'Активные голосования' },
  add_member: { qq: 'Кеңес ағза қосыў', ru: 'Добавить члена совета' },
  ...
  attendees: { qq: 'Қатнасқанлар', ru: 'Присутствующие' },
  ...
  settings: { qq: 'Сазламалар', ru: 'Настройки' },
  ...
  not_in_list: { qq: 'Сиз қатнақанлар дизиминде жоқсыз. Хаткерге хабарласың', ru: 'Вас нет в списке присутствующих. Обратитесь к секретарю' },
  pin_not_found: { qq: 'PIN табылмады', ru: 'PIN не найден' },
  pin_bound_other: { qq: 'Бул PIN басқа аккаунтқа бириктирилген', ru: 'Этот PIN привязан к другому аккаунту' },
  loading: { qq: 'Жүкленбекте...', ru: 'Загрузка...' },
  voter: { qq: 'Кеңес ағзасы', ru: 'Член совета' },
  admin: { qq: 'Хаткер (Админ)', ru: 'Секретарь (Админ)' },
  admin_login: { qq: 'Админ кириўи', ru: 'Вход для админа' },
  welcome: { qq: 'Хош келдиңиз', ru: 'Добро пожаловать' },
  error: { qq: 'Қәтелик', ru: 'Ошибка' },
  ...
  member_added: { qq: 'Кеңес ағзасы қосылды', ru: 'Член совета добавлен' },
  ...
  select_attendees_first: { qq: 'Алдын қатнасқанларды белгилең', ru: 'Сначала отметьте присутствующих' },
  ...
  delete_member_confirm: { qq: 'кеңес ағзасын өширесиз бе?', ru: 'Удалить члена совета?' },
  ...
  duplicate_pin: { qq: 'Бул PIN аллеқашан бар', ru: 'Этот PIN уже существует' },
  ...
  current_password: { qq: 'Әмелдеги пароль', ru: 'Текущий пароль' },
  ...
  account_created: { qq: 'Аккаунт жаратылды!', ru: 'Аккаунт создан!' },
  password_too_short: { qq: 'Пароль кеминде 6 белгиден болыўы керек', ru: 'Пароль должен быть не менее 6 символов' },
  password_min_length: { qq: 'Пароль кеминде 6 белги', ru: 'Минимум 6 символов' },
  username_taken: { qq: 'Бул логин бос емес', ru: 'Этот логин уже занят' },
  supabase_env_title: {
    qq: 'Supabase өзгериўшилери сазланбаған',
    ru: 'Не настроены переменные Supabase',
  },
  supabase_env_body: {
    qq: 'Vercel-де VITE_SUPABASE_URL және VITE_SUPABASE_PUBLISHABLE_KEY қосың, содан кейин қайта деплой етиң.',
    ru: 'В Vercel добавьте VITE_SUPABASE_URL и VITE_SUPABASE_PUBLISHABLE_KEY (Environment Variables) и заново задеплойте проект.',
  },
  fetch_failed_hint: {
    qq: 'Supabase пенен байланыс орнатылмай атыр.',
    ru: 'Не удаётся связаться с Supabase.',
  },
} as const;
