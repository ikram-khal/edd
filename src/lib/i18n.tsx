...
const translations = {
  ...
  protocol_number: { qq: 'Баянлама номери', ru: 'Номер протокола', en: 'Protocol number', uz: 'Bayonnoma raqami' },
  ...
  settings:        { qq: 'Сазламалар', ru: 'Настройки', en: 'Settings', uz: 'Sozlamalar' },
  download_report: { qq: 'Есабатты жүклеп алыў', ru: 'Скачать отчёт', en: 'Download report', uz: 'Hisobotni yuklab olish' },
  download_template:{ qq: 'Шаблонди жүклеп алыў', ru: 'Скачать шаблон', en: 'Download template', uz: 'Shablonni yuklab olish' },
  ...
  pin_bound_other: { qq: 'Бул PIN басқа аккаунтқа бириктирилген', ru: 'Этот PIN привязан к другому аккаунту', en: 'This PIN is bound to another account', uz: "Bu PIN boshqa akkountga bog'langan" },
  ...
  admin_login:     { qq: 'Админ ушын кириў', ru: 'Вход для админа', en: 'Admin login', uz: 'Admin kirishi' },
  ...
  member_added:    { qq: 'Ағза қосылды', ru: 'Член совета добавлен', en: 'Member added', uz: "A'zo qo'shildi" },
  ...
  select_attendees_first:{ qq: 'Алдын қатнасыўшыларды белгилең', ru: 'Сначала отметьте присутствующих', en: 'First select attendees', uz: 'Avval ishtirokchilarni belgilang' },
  ...
  no_members:      { qq: 'Ағзалар жоқ', ru: 'Членов совета нет', en: 'No members', uz: "A'zolar yo'q" },
  ...
  delete_member_confirm:{ qq: 'ағзасын өширесиз бе?', ru: 'Удалить члена совета?', en: 'Delete member?', uz: "a'zoni o'chirasizmi?" },
  delete_meeting_confirm:{ qq: 'Мәжилисти өшириў керек па?', ru: 'Удалить заседание?', en: 'Delete meeting?', uz: "Majlisni o'chirasizmi?" },
  delete_question_confirm:{ qq: 'Мәселени өшириў керек па?', ru: 'Удалить вопрос?', en: 'Delete question?', uz: "Savalni o'chirasizmi?" },
  duplicate_pin:   { qq: 'Бул PIN әллеқашан бар', ru: 'Этот PIN уже существует', en: 'This PIN already exists', uz: 'Bu PIN allaqachon mavjud' },
  ...
  question_label:  { qq: 'мәселе', ru: 'вопрос', en: 'question', uz: 'masala' },
  ...
  current_password:{ qq: 'Әмелдеги пароль', ru: 'Текущий пароль', en: 'Current password', uz: 'Joriy parol' },
  ...
  password_too_short:{ qq: 'Пароль кеминде 6 белигиден турыўы керек', ru: 'Пароль должен быть не менее 6 символов', en: 'Password must be at least 6 characters', uz: 'Parol kamida 6 ta belgidan iborat bo\'lishi kerak' },
  password_min_length:{ qq: 'Пароль кеминде 6 белги', ru: 'Минимум 6 символов', en: 'Minimum 6 characters', uz: 'Kamida 6 ta belgi' },
  username_taken:  { qq: 'Бул логин бос емес', ru: 'Этот логин уже занят', en: 'This username is already taken', uz: 'Bu login band' },
  supabase_env_title:{ qq: 'Сервер сазламалары жоқ', ru: 'Не настроены переменные Supabase', en: 'Supabase not configured', uz: 'Server sozlamalari yo\'q' },
  ...
  fetch_failed_hint:{ qq: 'Серверге қосылмай атыр. URL тексерің, VPN өшириң.', ru: 'Не удаётся связаться с Supabase. Проверь URL и сеть.', en: 'Cannot connect to server. Check the URL and network.', uz: 'Serverga ulanib bo\'lmadi. URL va tarmoqni tekshiring.' },
  recent_meetings: { qq: 'Соңғы мәжилислер', ru: 'Последние заседания', en: 'Recent meetings', uz: "So'nggi majlislar" },
  quick_actions:   { qq: 'Тез әмеллер', ru: 'Быстрые действия', en: 'Quick actions', uz: 'Tezkor amallar' },
  ...
  logged_in_as:    { qq: 'сыпатында кирдиниз', ru: 'Вы вошли как', en: 'Logged in as', uz: 'Kirgan akkount' },
  no_results:      { qq: 'Нәтийже табылмады', ru: 'Ничего не найдено', en: 'No results found', uz: 'Natija topilmadi' },
  go_to_members:   { qq: 'Ағзаларға өтиў', ru: 'Перейти к членам совета', en: 'Go to members', uz: "A'zolarga o'tish" },
  go_to_meetings:  { qq: 'Мәжилислерге өтиў', ru: 'Перейти к заседаниям', en: 'Go to meetings', uz: "Majlislarga o'tish" },
  live_badge:      { qq: 'Даўыс бериў жүрип атыр', ru: 'Идёт голосование', en: 'Live voting', uz: 'Ovoz berish ketmoqda' },
  reset_sessions:  { qq: 'Сессияларды тазалаў', ru: 'Сбросить сессии', en: 'Reset sessions', uz: 'Sessiyalarni tozalash' },
  reset_sessions_confirm:{ qq: 'Барлық ағзалар сеансларын тазаламақшысыз ба?', ru: 'Сбросить сессии всех участников?', en: 'Reset sessions for all members?', uz: "Barcha a'zolar sessiyalarini tozalaysizmi?" },
  sessions_reset:  { qq: 'Сеанслар тазаланды', ru: 'Сессии сброшены', en: 'Sessions reset', uz: 'Sessiyalar tozalandi' },
  copy_pins:       { qq: 'PIN-ларды нусхалаў', ru: 'Скопировать PIN-ы', en: 'Copy PINs', uz: 'PIN-larni nusxalash' },
  pins_copied:     { qq: 'PIN-лар нусхаланды', ru: 'PIN-ы скопированы', en: 'PINs copied', uz: 'PIN-lar nusxalandi' },
  ...
  question_updated:{ qq: 'Мәселе жаңаланды', ru: 'Вопрос обновлён', en: 'Question updated', uz: 'Savol yangilandi' },
  ...
  next_question:   { qq: 'Кейинги мәселе', ru: 'Следующий вопрос', en: 'Next question', uz: 'Keyingi masala' },
  finish_voting:   { qq: 'Даўыс бериўди жуўмақлаў', ru: 'Завершить голосование', en: 'Finish voting', uz: 'Ovoz berishni yakunlash' },
} as const;
