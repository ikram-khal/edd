...
const translations = {
  ...
  dashboard:       { qq: 'Басты бет', ru: 'Главная', en: 'Dashboard', uz: 'Bosh sahifa' },
  members:         { qq: 'Ағзалар', ru: 'Участники', en: 'Members', uz: "A'zolar" },
  ...
  add_member:      { qq: 'Ағза қосыў', ru: 'Добавить участника', en: 'Add member', uz: "A'zo qo'shish" },
